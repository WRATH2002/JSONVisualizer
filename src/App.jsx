...
function App() {
  ...
  const [currZoomIndex, setCurrZoomIndex] = useState(0);
              ...
              <div className="flex justify-start items-center ml-[-18px]">
                ...
                >
                  <Pyramid
                    ...
                    className=" mr-[10px]"
                    onClick={() => {
                      // handleZoomToNode("node-4");
                      // console.log(nodes);
                      // console.log(edges);
                      // getChildSubgraph("node-2", nodes, edges);
                    }}
                  />
              ...
              >
                ...
                >
                  ...
                  <CustomControls
                    ...
                    tempEdges={tempEdges}
                    tempNodes={tempNodes}
                    setSearchNodeArr={setSearchNodeArr}
          ...
          {modalData && (
            ...
            >
              ...
              >
                ...
                <pre
                  className="w-[calc(100%-20px)] ml-[10px] bg-[#161618] h-[calc(100%-130px)] p-[15px] text-[white] text-[14px] overflow-scroll rounded-lg border-[1.5px] border-[#2a2a2d]"
...
const ZoomToNodeButton = ({ nodes }) => {
  const { setCenter } = useReactFlow();

  const handleZoom = () => {
    const targetNode = nodes.find((node) => node.id === "node-21");
  ...
  return (
    <button
      className="fixed left-[50%] top-[50%] text-[white] z-[0]"
      onClick={handleZoom}
    >
      {/* Zoom to Node-4 */}
    </button>
